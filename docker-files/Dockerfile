...
#
###############################################################################
# Docker image for Support Scheduler micro service 
# FROM java:8
FROM alpine:3.4
MAINTAINER Marc Hammons <marc_hammons@dell.com>

RUN apk --update add openjdk8-jre

# environment variables
ENV APP_DIR=/edgex/edgex-support-scheduler
ENV APP=support-scheduler.jar
ENV APP_PORT=48085
