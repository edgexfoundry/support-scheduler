 ...
 * @author: Marc Hammons, Dell & Fede Claramonte, Cavium Networks
 * @version: 1.0.0
 *******************************************************************************/

package org.edgexfoundry.scheduling;

import static org.edgexfoundry.test.data.ScheduleData.TEST_FREQUENCY_1D;
import static org.edgexfoundry.test.data.ScheduleData.TEST_FREQUENCY_1D1H;
import static org.edgexfoundry.test.data.ScheduleData.TEST_FREQUENCY_1H;
import static org.edgexfoundry.test.data.ScheduleData.TEST_FREQUENCY_1M;
import static org.edgexfoundry.test.data.ScheduleData.TEST_SCHEDULE_ID1;
import static org.edgexfoundry.test.data.ScheduleData.TEST_SCHEDULE_ID2;
...
import static org.edgexfoundry.test.data.ScheduleData.TEST_TIME_2015;
...
public class ScheduleContextTest {
  ...
  public void testIsEqualFalse() {
    ...
    ScheduleContext sc2 = new ScheduleContext(s2);
    assertFalse("schedule contexts are equal.", sc1.equals(sc2));
  }

  @SuppressWarnings("unlikely-arg-type")
  @Test
  public void testIsEqualDifferentObjectType() {
    Schedule s1 = ScheduleData.newTestInstance();
    s1.setId(TEST_SCHEDULE_ID1);
    ScheduleContext sc1 = new ScheduleContext(s1);
    assertFalse("schedule context is equal to a string", sc1.equals("foo"));
  }
  ...
  public void testHashCode() {
    ...
    s1.setId(TEST_SCHEDULE_ID1);
    ScheduleContext sc1 = new ScheduleContext(s1);
    assertTrue("Hash code is equal to zero", sc1.hashCode() != 0);
  }
  ...
  public void testGetEndTime() {
    ...
    ZonedDateTime zdt = ZonedDateTime.parse(ScheduleData.TEST_TIME_2015, dtf);
    assertTrue(
        "schedule context endtime is incorrect. Is " + sc1.getEndTime() + " should be " + zdt,
  ...
  public void testFrequencyPT1D1H() {
    ...
    assertTrue("next time does not match", sc.getNextTime().compareTo(zdt1) > 0
  ...
  @Test
  public void testAddOneScheduleEventNoId() {
    Schedule s = ScheduleData.newTestInstance();
    ScheduleContext sc = new ScheduleContext(s);
    ScheduleEvent se = ScheduleEventData.newTestInstance();
    sc.addScheduleEvent(se);
    assertFalse("Should have returned false since event is already a key", sc.addScheduleEvent(se));
  }
  ...
  @Test
  public void testUpdateNextTime() {
    Schedule s = ScheduleData.newTestInstance();
    ScheduleContext sc = new ScheduleContext(s);
    sc.updateNextTime();
  }
